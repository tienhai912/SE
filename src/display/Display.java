...
public class Display {
	...
	private void init() {
		...
		client.handleRequestStations(client.handleRequest("http://localhost/stations/"), nameStations, idStations);
		client.handleRequestLines(client.handleRequest("http://localhost/lines/"), idLines);
		client.close();

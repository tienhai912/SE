	...
	public void decodeStations(String s, HashMap<String, Station> stations) {
		...
		try {
			...
			for (int i = 0; i < array.size(); i++) {
				...
				System.out.println("id " + obj2.get("id") + " code " + obj2.get("code") + " name " + obj2.get("name"));
	...
	public String decodeArrivalTime(String s) {
        ...
        try {
            ...
            for (int i = 0; i < array.size(); i++) {
                ...
                System.out.println(obj.get("destName") + " " + obj.get("destId") + " " + obj.get("nextTrain") + " " + obj.get("firstTrain") + " " + obj.get("lastTrain"));
          result = result + obj.get("destName") + "\nNext Train: " +obj.get("nextTrain") + "\nFirst Train: " + obj.get("firstTrain") + "\nLast Train: " + obj.get("lastTrain") + "\n";
            }
        } catch (ParseException pe) {
            pe.printStackTrace();
        }
